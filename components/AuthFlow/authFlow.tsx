...
import { View, Text, TextInput, TouchableOpacity, Image, Alert, ScrollView, ActivityIndicator, StyleSheet, Platform, LogBox, KeyboardAvoidingView } from "react-native";
